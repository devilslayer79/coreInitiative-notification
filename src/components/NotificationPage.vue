...
export default {
    ...
    addNotification(newNotification) {
      // Menambahkan notifikasi baru ke dalam array notifs
      this.notifs.push(newNotification);
    }
    },
    data() {
        return {
...
<template>
    <div class="w-screen flex overflow-auto">
        <div class="w-6/12 mx-auto h-screen bg-white shadow-lg px-12 py-10">
            <!-- header -->
            ...
            <div v-for="(notif, index) in notifs" :key="index" class="p-4 bg-slate-100 rounded-md mb-4">
                ...
                <div class="flex gap-4 items-start">
                    ...
                    <img src="../assets/images/avatar-angela-gray.webp" alt="avatar thumbnail" class="w-10">
                    <!-- text -->
                    <div class="">
                        <div>
